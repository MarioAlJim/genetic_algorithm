"""Performance test of valid GA configurations using Selenium."""
...
def main():
    """Execute multiple GA configurations and measure performance."""
    ...
    for idx, config in enumerate(CONFIGURATIONS, start=1):
        ...
        print(f"PCU01{idx} completed in {duration:.2f} seconds.\n")
        time.sleep(2)
    ...
    for test_id, time_taken in results:
        print(f"{test_id}: {time_taken:.2f} seconds")
